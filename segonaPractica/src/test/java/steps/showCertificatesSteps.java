...
public class showCertificatesSteps {
	...
	*/
	@When("the user clicks the Certificates option")
	public void theUserClicksTheCertificatesOption() 
	{
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/div[2]/div/div/nav/ul/li[3]/a")));
		driver.findElement(By.xpath("/html/body/div[2]/div/div/nav/ul/li[3]/a")).click();
	}
		
	
	@Then("the certificates list appears")
	public void theCertificatesListAppears()
	{
		String title = driver.findElement(By.className("my-account__heading")).getText();
		Assert.assertEquals(title, "My Certificates");
	}
