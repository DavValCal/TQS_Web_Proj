...
public class showUserDashboardSteps {
	...
	*/
	@When("the user clicks the MyDashboard option")
	public void theUserClicksTheMyDashboardOption() 
	{
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("/html/body/header/div[2]/div/nav/ul/li[1]/a")));
		driver.findElement(By.xpath("/html/body/header/div[2]/div/nav/ul/li[1]/a")).click();
	}
		
	
	@Then("the user dashboard page appears")
	public void theUserDashboardPageAppears()
	{
		String title = driver.findElement(By.id("my-courses-heading")).getText();
		Assert.assertEquals(title, "My courses");
	}
